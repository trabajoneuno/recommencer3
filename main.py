...
class RecommendationSystem:
    ...
    def process_data(self, csv_path: str):
        ...
        logger.info("Reading unique values...")
        ...
        logger.info(f"Found {len(unique_values['name'])} unique names and {len(unique_values['main_category'])} unique categories")
        ...
        # Set up ID mappings
        logger.info("Setting up ID mappings...")
        ...
        logger.info(f"Data processing complete. Processed {chunk_count} chunks total.")
